...
IMPORTANT : la boutique 3D modèle Metagora est une bijouterie avec des bustes à colliers et des présentoirs à bijoux. Si les produits cibles (${d}) ne sont PAS des bijoux ou colliers, il faut impérativement remplacer tous les bustes, mannequins à colliers et présentoirs à bijoux par du mobilier de présentation adapté aux produits ${d} (étagères, vitrines, présentoirs plats, supports technologiques, etc.). Ne conserver les bustes à colliers QUE si ${d} concerne effectivement des bijoux ou colliers.
